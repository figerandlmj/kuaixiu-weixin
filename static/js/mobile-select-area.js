    ...
    MobileSelectArea.prototype = {
        ...
        bindEvent: function() {
            ...
            this.trigger.tap(function(e) {
                $.confirm('<div class="ui-scroller-mask"><div id="' + _this.id + '" class="ui-scroller"><div></div><div ></div><div></div><p></p></div></div>', null,
                function(t, c) {
                    if (t == "yes") {
                        _this.submit()
                    }
                ...
                _this.scroller.children().bind("touchstart",
                function(e) {
                    start = e.changedTouches[0].pageY
                });
                _this.scroller.children().bind("touchmove",
                function(e) {
                ...
                _this.scroller.children().bind("touchend",
                function(e) {
                    end = e.changedTouches[0].pageY;
                    var diff = end - start;
                    var dl = $(e.target).parent();
